    ...
    @if(!$order)
        <div class="text-center my-5 py-5">
            <div class="mb-4">
                ...
                <h3 class="mt-3">Aucune commande ancienne</h3>
                <p class="text-muted">Il n'y a pas de commandes anciennes à traiter pour le moment.</p>
            </div>
        </div>
    @else
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-secondary">{{ $order->attempt_count }} tentative(s)</span>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('manager.orders.process', $order) }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    ...
                                    <tr>
                                        <th>Statut:</th>
                                        <td><span class="badge bg-secondary">Ancienne</span></td>
                                    </tr>
                                    <tr>
                                        <th>Tentatives:</th>
                                        <td>{{ $order->attempt_count }}</td>
                                    </tr>
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="action_schedule">
                                    <i class="bi bi-calendar-date text-info"></i> Programmer
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Veuillez indiquer la raison de la programmation.</div>
                                </div>
                            </div>
                        </div>
                    </div>
