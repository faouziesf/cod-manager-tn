        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>{{ __('Commandes anciennes') }}</span>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('admin.orders.old') }}">Anciennes</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <tbody>
                                @forelse ($orders as $order)
                                    <tr>
                                        ...
                                        <td>{{ $order->current_attempts }}/{{ $order->max_attempts }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">Aucune commande ancienne trouvée</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
