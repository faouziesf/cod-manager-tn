...
<head>
    ...
    <title>@yield('title') - COD Manager TN</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="sidebar">
            ...
            <!-- Nav Item - Orders -->
            <li class="nav-item {{ request()->routeIs('manager.orders.*') ? 'active' : '' }}">
            ...
            <!-- Nav Item - Standard Orders -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('manager.orders.standard') }}">
                    <i class="fas fa-fw fa-clipboard-list"></i>
                    <span>Commandes standard</span>
                </a>
            </li>

            <!-- Nav Item - Scheduled Orders -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('manager.orders.scheduled') }}">
                    <i class="fas fa-fw fa-calendar-alt"></i>
                    <span>Commandes programmées</span>
                </a>
            </li>
            ...
            <!-- Nav Item - Products -->
            <li class="nav-item {{ request()->routeIs('manager.products.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('manager.products.index') }}">
            ...
            <li class="nav-item {{ request()->routeIs('manager.reports.*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('manager.reports.daily') }}">
