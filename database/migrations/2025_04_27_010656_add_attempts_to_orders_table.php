...
return new class extends Migration
{
    ...
    {
        Schema::table('orders', function (Blueprint $table) {
            $table->dropColumn(['attempt_count', 'daily_attempt_count', 'last_attempt_at', 'next_attempt_at', 
                            'scheduled_date', 'max_attempts', 'max_daily_attempts', 'confirmed_price', 'status']);
